...
from fastapi_users.router import get_auth_router, get_register_router, get_reset_password_router, get_verify_router
...
router.include_router(
    get_verify_router(User, get_user_manager),
    prefix="/auth",
    tags=["authentication"]
)
