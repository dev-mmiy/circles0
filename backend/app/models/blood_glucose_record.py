...
class BloodGlucoseRecord(Base):
    ...
    value = Column(Integer, nullable=False, comment="Blood glucose level (mg/dL)")
    timing = Column(
        String(20),
        nullable=True,
    ...
    # Relationships
    user = relationship("User", back_populates="blood_glucose_records")
