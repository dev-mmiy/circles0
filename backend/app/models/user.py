...
class User(Base):
    ...
    def _format_name_template(self, template: str, first_name: str, middle_name: str, last_name: str) -> str:
...
class LocaleNameFormat(Base):
    ...
    default_order_code = Column(String(20), ForeignKey("name_display_orders.order_code"))
    is_active = Column(Boolean, default=True)
    created_at = Column(DateTime, default=func.current_timestamp())
