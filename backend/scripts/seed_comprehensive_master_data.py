...
def seed_diseases(session):
    ...
    diseases = [
        ...
        {
            "disease_code": "G12.2",
            "name": "ALS (Motor neurone disease)",
            "severity_level": 5,
        },
    ...
    session.commit()
    print(
        f"Comprehensive diseases seeded successfully! Total: {len(diseases)} diseases"
    )
    return disease_map
...
def seed_disease_translations(session, disease_map):
    ...
    translations = [
        # 心臓・血管の病気
        {
            ...
            "details_ja": "心臓の血管が詰まり心筋が壊死する重篤な疾患",
            "details_en": "Serious condition where heart muscle tissue dies due to blocked blood vessels",
        },
        {
            "code": "I20.9",
            "ja": "狭心症",
            "en": "Angina Pectoris",
            "details_ja": "心臓への血流が一時的に不足し胸痛が起こる",
            "details_en": "Chest pain caused by temporary reduction in blood flow to the heart",
        },
        {
            "code": "I50.9",
            "ja": "心不全",
            "en": "Heart Failure",
            "details_ja": "心臓のポンプ機能が低下し全身に十分な血液を送れない状態",
            "details_en": "Condition where the heart cannot pump enough blood to meet the body's needs",
        },
        {
            "code": "I49.9",
            "ja": "不整脈",
            "en": "Cardiac Arrhythmia",
            "details_ja": "心臓のリズムが乱れる状態",
            "details_en": "Irregular heart rhythm",
        },
        {
            "code": "I64",
            "ja": "脳卒中",
            "en": "Stroke",
            "details_ja": "脳梗塞や脳出血により脳の機能が障害される",
            "details_en": "Brain damage caused by cerebral infarction or hemorrhage",
        },
        # 脳と神経の病気
        {
            "code": "G30.9",
            ...
            "details_ja": "進行性の認知症で記憶や思考能力が徐々に低下",
            "details_en": "Progressive dementia with gradual decline in memory and cognitive abilities",
        },
        {
            "code": "F00.9",
            "ja": "認知症",
            "en": "Dementia",
            "details_ja": "記憶力や判断力が低下し日常生活に支障をきたす",
            "details_en": "Decline in memory and judgment affecting daily life",
        },
        {
            "code": "G20",
            "ja": "パーキンソン病",
            "en": "Parkinson's Disease",
            "details_ja": "手足の震えや動作の遅さが特徴的な神経変性疾患",
            "details_en": "Neurodegenerative disease characterized by tremors and slow movement",
        },
        {
            "code": "G12.2",
            "ja": "ALS（筋萎縮性側索硬化症）",
            "en": "ALS (Motor Neurone Disease)",
            "details_ja": "運動神経が侵され筋力が低下していく難病",
            "details_en": "Progressive disease affecting motor neurons leading to muscle weakness",
        },
        {
            "code": "G40.9",
            "ja": "てんかん",
            "en": "Epilepsy",
            "details_ja": "脳の異常な電気活動により発作が起こる",
            "details_en": "Seizures caused by abnormal electrical activity in the brain",
        },
        # 肺・呼吸の病気
        {
            "code": "C34.9",
            "ja": "肺がん",
            "en": "Lung Cancer",
            "details_ja": "肺に発生する悪性腫瘍",
            "details_en": "Malignant tumor in the lungs",
        },
        {
            "code": "J44.9",
            "ja": "COPD（慢性閉塞性肺疾患）",
            "en": "COPD",
            "details_ja": "気道が慢性的に炎症を起こし呼吸困難となる",
            "details_en": "Chronic inflammation of airways causing breathing difficulties",
        },
        {
            "code": "J18.9",
            "ja": "肺炎",
            "en": "Pneumonia",
            "details_ja": "肺に炎症が起こり発熱や咳が出る",
            "details_en": "Lung inflammation with fever and cough",
        },
        {
            "code": "J84.1",
            "ja": "肺線維症",
            "en": "Pulmonary Fibrosis",
            "details_ja": "肺組織が硬くなり呼吸機能が低下する",
            "details_en": "Lung tissue becomes stiff, reducing respiratory function",
        },
        {
            "code": "J45.9",
            "ja": "喘息",
            "en": "Asthma",
            "details_ja": "気道が過敏になり発作的に呼吸困難が起こる",
            "details_en": "Hypersensitive airways causing episodic breathing difficulties",
        },
        # 胃・腸・肝臓・すい臓の病気
        {
            "code": "C16.9",
            "ja": "胃がん",
            "en": "Gastric Cancer",
            "details_ja": "胃に発生する悪性腫瘍",
            "details_en": "Malignant tumor in the stomach",
        },
        {
            "code": "C18.9",
            "ja": "大腸がん",
            "en": "Colorectal Cancer",
            "details_ja": "大腸に発生する悪性腫瘍",
            "details_en": "Malignant tumor in the colon or rectum",
        },
        {
            "code": "C25.9",
            "ja": "膵がん",
            "en": "Pancreatic Cancer",
            "details_ja": "すい臓に発生する悪性腫瘍",
            "details_en": "Malignant tumor in the pancreas",
        },
        {
            "code": "C22.9",
            "ja": "肝がん",
            "en": "Liver Cancer",
            "details_ja": "肝臓に発生する悪性腫瘍",
            "details_en": "Malignant tumor in the liver",
        },
        {
            "code": "K74.6",
            "ja": "肝硬変",
            "en": "Liver Cirrhosis",
            "details_ja": "肝臓が硬く変化し機能が低下する",
            "details_en": "Liver becomes hard and loses function",
        },
        {
            "code": "K51.9",
            "ja": "潰瘍性大腸炎",
            "en": "Ulcerative Colitis",
            "details_ja": "大腸の粘膜に潰瘍ができる慢性疾患",
            "details_en": "Chronic disease with ulcers in the colon lining",
        },
        {
            "code": "K50.9",
            "ja": "クローン病",
            "en": "Crohn's Disease",
            "details_ja": "消化管全体に炎症が起こる慢性疾患",
            "details_en": "Chronic inflammation throughout the digestive tract",
        },
        {
            "code": "B18.1",
            "ja": "B型肝炎",
            "en": "Chronic Hepatitis B",
            "details_ja": "B型肝炎ウイルスによる慢性肝炎",
            "details_en": "Chronic liver inflammation caused by hepatitis B virus",
        },
        {
            "code": "B18.2",
            "ja": "C型肝炎",
            "en": "Chronic Hepatitis C",
            "details_ja": "C型肝炎ウイルスによる慢性肝炎",
            "details_en": "Chronic liver inflammation caused by hepatitis C virus",
        },
        # 腎臓・泌尿器の病気
        {
            "code": "N18.9",
            ...
            "details_ja": "腎臓の機能が徐々に低下し透析が必要になることも",
            "details_en": "Progressive loss of kidney function, may require dialysis",
        },
        {
            "code": "C64.9",
            "ja": "腎がん",
            "en": "Kidney Cancer",
            "details_ja": "腎臓に発生する悪性腫瘍",
            "details_en": "Malignant tumor in the kidney",
        },
        {
            "code": "C61",
            "ja": "前立腺がん",
            "en": "Prostate Cancer",
            "details_ja": "前立腺に発生する悪性腫瘍",
            "details_en": "Malignant tumor in the prostate",
        },
        {
            "code": "N04.9",
            "ja": "ネフローゼ症候群",
            "en": "Nephrotic Syndrome",
            "details_ja": "腎臓から大量のタンパクが漏れ出る状態",
            "details_en": "Condition where kidneys leak large amounts of protein",
        },
        # 血液や免疫の病気
        {
            "code": "C91.9",
            "ja": "白血病",
            "en": "Leukemia",
            "details_ja": "血液のがんで異常な白血球が増える",
            "details_en": "Blood cancer with abnormal white blood cell proliferation",
        },
        {
            "code": "C85.9",
            "ja": "リンパ腫",
            "en": "Lymphoma",
            "details_ja": "リンパ系の悪性腫瘍",
            "details_en": "Malignant tumor of the lymphatic system",
        },
        {
            "code": "M32.9",
            "ja": "全身性エリテマトーデス（SLE）",
            "en": "Systemic Lupus Erythematosus",
            "details_ja": "全身の臓器に炎症が起こる自己免疫疾患",
            "details_en": "Autoimmune disease causing inflammation in multiple organs",
        },
        {
            "code": "M06.9",
            "ja": "関節リウマチ",
            "en": "Rheumatoid Arthritis",
            "details_ja": "関節に炎症が起こり痛みや変形が生じる",
            "details_en": "Joint inflammation causing pain and deformity",
        },
        {
            "code": "D80.9",
            "ja": "原発性免疫不全症",
            "en": "Primary Immunodeficiency",
            "details_ja": "生まれつき免疫機能が低下している",
            "details_en": "Congenital impairment of immune function",
        },
        # 代謝・内分泌の病気
        {
            "code": "E11.9",
            ...
            "details_ja": "インスリンの働きが悪くなり血糖値が高くなる",
            "details_en": "High blood sugar due to impaired insulin function",
        },
        {
            "code": "E10.9",
            "ja": "1型糖尿病",
            "en": "Type 1 Diabetes Mellitus",
            "details_ja": "インスリンが分泌されず血糖値が高くなる",
            "details_en": "High blood sugar due to lack of insulin production",
        },
        {
            "code": "E05.9",
            "ja": "甲状腺機能亢進症",
            "en": "Hyperthyroidism",
            "details_ja": "甲状腺ホルモンが過剰に分泌される",
            "details_en": "Excessive thyroid hormone production",
        },
        {
            "code": "E03.9",
            "ja": "甲状腺機能低下症",
            "en": "Hypothyroidism",
            "details_ja": "甲状腺ホルモンの分泌が不足する",
            "details_en": "Insufficient thyroid hormone production",
        },
        {
            "code": "E78.5",
            "ja": "脂質異常症",
            "en": "Dyslipidemia",
            "details_ja": "血液中のコレステロールや中性脂肪が異常値を示す",
            "details_en": "Abnormal levels of cholesterol and triglycerides in blood",
        },
        {
            "code": "E66.9",
            "ja": "肥満症",
            "en": "Obesity",
            "details_ja": "体脂肪が過剰に蓄積した状態",
            "details_en": "Excessive accumulation of body fat",
        },
        # 精神・こころの病気
        {
            "code": "F32.9",
            ...
            "details_ja": "気分の落ち込みが続き日常生活に支障をきたす",
            "details_en": "Persistent low mood affecting daily life",
        },
        {
            "code": "F20.9",
            "ja": "統合失調症",
            "en": "Schizophrenia",
            "details_ja": "幻覚や妄想が現れる精神疾患",
            "details_en": "Mental disorder with hallucinations and delusions",
        },
        {
            "code": "F41.9",
            "ja": "不安症",
            "en": "Anxiety Disorder",
            "details_ja": "過度な不安や心配が続く状態",
            "details_en": "Persistent excessive anxiety and worry",
        },
        {
            "code": "F41.0",
            "ja": "パニック障害",
            "en": "Panic Disorder",
            "details_ja": "突然の強い不安と身体症状が起こる",
            "details_en": "Sudden intense anxiety with physical symptoms",
        },
        # がん（その他）
        {
            "code": "C50.9",
            "ja": "乳がん",
            "en": "Breast Cancer",
            "details_ja": "乳房に発生する悪性腫瘍",
            "details_en": "Malignant tumor in the breast",
        },
        {
            "code": "C53.9",
            "ja": "子宮頸がん",
            "en": "Cervical Cancer",
            "details_ja": "子宮頸部に発生する悪性腫瘍",
            "details_en": "Malignant tumor in the cervix",
        },
        {
            "code": "C54.1",
            "ja": "子宮体がん",
            "en": "Uterine Cancer",
            "details_ja": "子宮体部に発生する悪性腫瘍",
            "details_en": "Malignant tumor in the uterine body",
        },
        # 感染症
        {
            "code": "A15.9",
            "ja": "結核",
            "en": "Tuberculosis",
            "details_ja": "結核菌による感染症で主に肺が侵される",
            "details_en": "Bacterial infection primarily affecting the lungs",
        },
        {
            "code": "B24",
            "ja": "HIV/AIDS",
            "en": "HIV/AIDS",
            "details_ja": "免疫機能が低下するウイルス感染症",
            "details_en": "Viral infection causing immune system deterioration",
        },
        {
            "code": "U07.1",
            "ja": "新型コロナウイルス感染症",
            "en": "COVID-19",
            "details_ja": "SARS-CoV-2ウイルスによる呼吸器感染症",
            "details_en": "Respiratory infection caused by SARS-CoV-2 virus",
        },
        # 生まれつき・遺伝の病気
        {
            "code": "G71.0",
            ...
            "details_ja": "筋肉が徐々に弱くなる遺伝性疾患",
            "details_en": "Genetic disease causing progressive muscle weakness",
        },
        {
            "code": "Q90.9",
            "ja": "ダウン症",
            "en": "Down Syndrome",
            "details_ja": "21番染色体が1本多い染色体異常症",
            "details_en": "Chromosomal disorder with an extra chromosome 21",
        },
        {
            "code": "Q24.9",
            "ja": "先天性心疾患",
            "en": "Congenital Heart Disease",
            "details_ja": "生まれつき心臓に構造的な異常がある",
            "details_en": "Structural heart abnormality present at birth",
        },
        {
            "code": "E70.9",
            "ja": "代謝異常症",
            "en": "Metabolic Disorder",
            "details_ja": "生まれつき代謝に異常がある疾患",
            "details_en": "Congenital disorder affecting metabolism",
        },
    ]
...
def seed_disease_category_mappings(session, disease_map, category_map):
    ...
    mappings = [
        ...
        ("N04.9", "RENAL"),
        # 血液や免疫の病気
        ("C91.9", "HEMATOLOGIC_IMMUNE"),
        ("C85.9", "HEMATOLOGIC_IMMUNE"),
        ("M32.9", "HEMATOLOGIC_IMMUNE"),
        ("M06.9", "HEMATOLOGIC_IMMUNE"),
        ("D80.9", "HEMATOLOGIC_IMMUNE"),
        # 代謝・内分泌の病気
        ("E11.9", "METABOLIC_ENDOCRINE"),
        ("E10.9", "METABOLIC_ENDOCRINE"),
        ("E05.9", "METABOLIC_ENDOCRINE"),
        ("E03.9", "METABOLIC_ENDOCRINE"),
        ("E78.5", "METABOLIC_ENDOCRINE"),
        ("E66.9", "METABOLIC_ENDOCRINE"),
        # 精神・こころの病気
        ("F32.9", "MENTAL_HEALTH"),
        ("F20.9", "MENTAL_HEALTH"),
        ("F41.9", "MENTAL_HEALTH"),
        ...
        ("B18.2", "INFECTIOUS"),
        # 生まれつき・遺伝の病気
        ("G71.0", "CONGENITAL_GENETIC"),
        ("Q90.9", "CONGENITAL_GENETIC"),
        ("Q24.9", "CONGENITAL_GENETIC"),
        ("E70.9", "CONGENITAL_GENETIC"),
    ]
