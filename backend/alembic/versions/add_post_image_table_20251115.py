...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('image_url', sa.String(length=500), nullable=False, comment='URL to the image file'),
        sa.Column('display_order', sa.Integer(), nullable=False, server_default='0', comment='Order for displaying images'),
