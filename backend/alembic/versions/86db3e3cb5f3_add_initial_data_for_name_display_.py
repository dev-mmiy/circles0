...
def upgrade() -> None:
    ...
    name_display_orders_table = sa.table('name_display_orders',
    ...
    op.bulk_insert(name_display_orders_table, [
        {
            'order_code': 'western',
    ...
    locale_name_formats_table = sa.table('locale_name_formats',
        sa.column('locale', sa.String),
        sa.column('default_order_code', sa.String),
        sa.column('is_active', sa.Boolean)
    )
    
    op.bulk_insert(locale_name_formats_table, [
        {
            'locale': 'ja-jp',
