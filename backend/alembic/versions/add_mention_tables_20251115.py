...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_post_mentions_mentioned_user_id'), 'post_mentions', ['mentioned_user_id'])
    ...
    op.create_index(op.f('ix_comment_mentions_comment_id'), 'comment_mentions', ['comment_id'])
    op.create_index(op.f('ix_comment_mentions_mentioned_user_id'), 'comment_mentions', ['mentioned_user_id'])
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_post_mentions_mentioned_user_id'), table_name='post_mentions')
