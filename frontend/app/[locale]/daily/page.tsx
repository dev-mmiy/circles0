...
type RecordType = 'vital' | 'meal' | 'all';
...
export default function DailyPage() {
  ...
  const {
    ...
    clearError,
      ...
      if (recordType === 'all') {
        ...
        const mealRecords = await getUserPosts(user.id, skip, Math.ceil(limit / 2), 'meal', token);
        
        // Combine and sort by created_at
        const allRecords = [...vitalRecords, ...mealRecords].sort(
  ...
  }, [isAuthenticated, user, authLoading, recordType, load]);
